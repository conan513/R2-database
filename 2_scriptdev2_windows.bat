...
mysql -u root --password=123456 -h 127.0.0.1 --port=3310 --database=mangos < "scriptdev2\sql\mangos_scriptname_clear.sql"
mysql -u root --password=123456 -h 127.0.0.1 --port=3310 --database=mangos < "scriptdev2\sql\mangos_scriptname_full.sql"
